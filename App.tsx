...
const initialResumeData: ResumeData = {
  personalInfo: {
    name: 'Yashraj Tripathi',
    title: 'Senior Frontend Developer',
    email: 'yashraj.tripathi@email.com',
    phone: '123-456-7890',
    location: 'San Francisco, CA',
    website: 'yashrajtripathi.dev',
  },
        ...
        <div className="min-h-screen font-sans text-gray-800 bg-slate-200">
             <header className="bg-white/80 shadow-md sticky top-0 z-20 backdrop-blur-md">
                <div className="container mx-auto px-4 py-3 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
                    <button onClick={onBack} className="flex items-center text-sm font-semibold text-gray-700 hover:text-indigo-600 transition-colors self-start sm:self-center">
            ...
            <main className="py-6 sm:py-10 flex justify-center overflow-x-auto">
                <div className="w-[8.5in] origin-top transform scale-[0.4] sm:scale-[0.65] md:scale-[0.8] lg:scale-100">
  ...
  return (
    <div className="min-h-screen font-sans text-gray-800 flex flex-col">
      <header className="bg-white shadow-sm">
        <div className="container mx-auto px-6 py-4">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Resume Builder</h1>
           <p className="text-gray-600 mt-1">Fill in your details and get AI-assisted suggestions to craft the perfect resume.</p>
        </div>
      </header>
        ...
        <div className="max-w-3xl mx-auto">
            ...
            <div className="mt-8 text-center">
                 <button
                    ...
                    className="bg-indigo-600 text-white px-6 py-3 text-base sm:text-lg rounded-lg font-semibold hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-opacity-50 transition-all duration-200 transform hover:scale-105"
                >
                    Preview & Download
                </button>
            </div>
      ...
      <footer className="text-center py-6 text-sm text-slate-500">
        <p>Made with ♥ in India by Yashraj Tripathi</p>
      </footer>
    </div>
  );
};
